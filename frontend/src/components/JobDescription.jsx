...
import { APPLICATIION_API_END_POINT, JOB_API_END_POINT } from '@/utils/constant';
    ...
    const [isApplied, setIsApplied] = useState(isInitiallyApplied);
     const applyJobHandler= async ()=>{
        try {
            ...
            const res = await axios.get(`${APPLICATIION_API_END_POINT}/apply/${jobId}`,{withCredentials: true});
